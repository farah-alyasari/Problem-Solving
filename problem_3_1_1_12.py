...
def batteries_check():
    ...
    if battery_charge < 100 or battery_charge > 500:
        raise RocketNotReadyError("Charge level is not safe")

def circuits_check():
    # add your own implentation
    if circuit_wired is False:
        raise RocketNotReadyError("Circuit is not safe")


crew = ['John', 'Mary', 'Mike']
fuel = 100
battery_charge = 800 #volts
circuit_wired = False
